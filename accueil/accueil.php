...
<body>
    <div class="containers">
        ...
        <div class="header">
            ...
            <hr>
            <div class="menu">
                <img style="width: 279px; height: 91px;" src="../images/LOGO BOX TV_ 3.png" alt="">
                <div class="nav">
                    <ul>
                        ...
                        <li class="commencer"><button type="button">Commencer</button></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="main">
            ...
            <div class="section2">
                <div class="block">
                    ...
                    <div class="lorem-img">
                        <img style="width: 318px; height: 153px; border-radius: 20px; margin-right: 20px; position: relative;
                            "src="../images/japanese-spouses-using-tablet-browsing-internet-sitting-on-couch-indoor 2.png" alt="">
                ...
                <div class="brothers">
                    <img style="width: 478px; height: 478px; border-radius: 100%; position: relative;
                        " src="../images/brothers-playing-on-playstation-e1615963163461 1.png" alt="">
                    <div class="peer">
                        <p class="up">Up To</p>
                        <p class="mb">100 MB</p>
            ...
            <div class="section3">
                <div class="element">
                    ...
                    <div><p class="ch">250+ Channels</p></div>
                </div>
                <div class="element">
                    <div style="text-align: center;"><img style=" width: 80px; height: 80px; padding: 10px 10px 16.666667938232422px 10px;
                        " src="../images/la_rocket.png" alt=""></div>
                    <div><p class="ss">Speed Seamless</p></div>
                </div>
                <div class="element">
                    <div style="text-align: center;"><img style="width: 80px; height: 80px; padding: 10px 10px 16.666667938232422px 10px;
                        " src="../images/solar_server-minimalistic-linear.png" alt=""></div>
                    <div><p class="fi">Free Installation</p></div>
                </div>
                <div class="element">
                    <div style="text-align: center;"><img style="width: 80px; height: 80px; padding: 10px 10px 16.666667938232422px 10px;
                        " src="../images/uil_rss-interface.png" alt=""></div>
                    <div><p class="qa">4K & 8K Quality</p></div>
                </div>
                <div class="element">
                    <div style="text-align: center;"><img style="width: 80px; height: 80px; padding: 10px 10px 16.666667938232422px 10px;
                        " src="../images/solar_wallet-money-linear.png" alt=""></div>
                    <div><p class="ft">Flexible Tariff Plans</p></div>
                </div>
                <div class="element">
                    <div style="text-align: center;"><img style="width: 80px; height: 80px; padding: 10px 10px 16.666667938232422px 10px;
            ...
            <div class="section5">
                ...
                <div class="container-achat">
                    ...
                    <div class="achat">
                        <div class="promo">Promo</div>
                        <img src="../images/z10-pro-300x222 (1) 1.png" alt="">
            ...
            <div class="section7">
                <div class="content-block">
                    <img style="width: 1519px; height: 488px;
                        "src="../images/japanese-spouses-using-tablet-browsing-internet-sitting-on-couch-indoor 1.png" alt="" srcset="">
                    <div style="width: 1519px; height: 488px; background: linear-gradient(180deg, rgba(68, 58, 89, 0.76) 0%, rgba(0, 0, 0, 0.41) 81.99%, rgba(0, 0, 0, 0.33) 100%); position: absolute; top: 0;" class="content-opacity"></div>
